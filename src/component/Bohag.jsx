...
export default function Calendar1() {
  ...
  const customDays = [
    ...
    { day: '১৩', content: '27 April', color: 'white', details: 'দেৱানগাওঁ গোৱালপাৰাত শ্রীশ্ৰী মহাৰাণী পূজা উৎসব।' },
  ...
  const handleDateClick = (day) => {
    setSelectedDate(day); // Update selected date to show its details
  };
  ...
  return (
    <>
      <div>
        ...
        {/* Only show details when a date is selected */}
        {selectedDate && (
        ...
        <ul className="days">
          {customDays.map(({ day, content, color, details }) => (
            <li
              ...
              onClick={() => handleDateClick({ content, details })}
            >
              {day}
              <div>{content}</div>
            </li>
